...
### 도구
- [tfsec](https://github.com/aquasecurity/tfsec) - IaC 보안 스캐너
- [terraform-docs](https://terraform-docs.io/) - 문서 자동 생성기
- [infracost](https://www.infracost.io/) - 비용 추정 도구
- [pre-commit-terraform](https://github.com/antonbabenko/pre-commit-terraform) - Terraform 전용 pre-commit 훅 모음

...
region_primary = "YOUR_REGION_PRIMARY"
region_backup  = "YOUR_REGION_BACKUP"

# Bootstrap 폴더 설정 (environment_folder_ids 키 조회용)
# 형식: product/region/env → "my-project/asia-northeast3/LIVE"
folder_product = "YOUR_FOLDER_PRODUCT"
folder_region  = "YOUR_FOLDER_REGION"
folder_env     = "YOUR_FOLDER_ENV"
...
network_config = {
  ...
  # VPC Peering
  peering = {
    mgmt_project_id  = "YOUR_MGMT_PROJECT_ID"

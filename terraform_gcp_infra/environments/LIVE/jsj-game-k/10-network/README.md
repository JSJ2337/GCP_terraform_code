# 10-network 레이어
> Terragrunt: environments/LIVE/jsj-game-k/10-network/terragrunt.hcl
...
```hcl
additional_subnets = [
  { name = "game-k-subnet-dmz",     region = "asia-northeast3", cidr = "10.3.0.0/24" },
  { name = "game-k-subnet-private", region = "asia-northeast3", cidr = "10.3.1.0/24" },
  { name = "game-k-subnet-db",      region = "asia-northeast3", cidr = "10.3.2.0/24" }
]

dmz_subnet_name     = "game-k-subnet-dmz"
private_subnet_name = "game-k-subnet-private"
db_subnet_name      = "game-k-subnet-db"
```

# 50-workloads 레이어
> Terragrunt: environments/LIVE/jsj-game-m/50-workloads/terragrunt.hcl
...
instances = {
  "web-server-01" = {
    subnetwork_self_link = "projects/jsj-game-m/regions/asia-northeast3/subnetworks/game-m-subnet-dmz"
  ...
  "app-server-01" = {
    subnetwork_self_link = "projects/jsj-game-m/regions/asia-northeast3/subnetworks/game-m-subnet-private"
  ...
  "db-proxy-01" = {
    subnetwork_self_link = "projects/jsj-game-m/regions/asia-northeast3/subnetworks/game-m-subnet-db"
...
**예시:**
- DMZ 서브넷: `projects/jsj-game-m/regions/asia-northeast3/subnetworks/game-m-subnet-dmz`
- Private/WAS 서브넷: `projects/jsj-game-m/regions/asia-northeast3/subnetworks/game-m-subnet-private`
- DB 서브넷: `projects/jsj-game-m/regions/asia-northeast3/subnetworks/game-m-subnet-db`
...
`terragrunt output instance_groups` 명령으로 생성된 Instance Group self-link를 확인한 뒤, Load Balancer 백엔드(`70-loadbalancers/<lb>/terraform.tfvars`)의 `backends` 항목에 전달하면 됩니다.
...
- LB 백엔드로 연결하려면 `70-loadbalancers/<lb>` 레이어에서 동일한 인스턴스 그룹 Self Link를 참조하세요.
...
- 실제 운영 예제: `environments/LIVE/jsj-game-m/50-workloads/terraform.tfvars`

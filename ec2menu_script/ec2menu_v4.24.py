...
# -*- coding: utf-8 -*-
"""
EC2, RDS, ElastiCache 접속 자동화 스크립트 v5.3 (Linux 접속 오류 수정)
...
- v4.23에서 발생한 Linux SSM 접속 오류 수정
"""
import os
import sys
import argparse
...
# ----------------------------------------------------------------------------
def main():
    parser = argparse.ArgumentParser(description='AWS EC2/RDS/ElastiCache 연결 도구 v5.3')

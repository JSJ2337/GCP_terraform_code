...
# -*- coding: utf-8 -*-
"""
EC2, RDS, ElastiCache, ECS 접속 자동화 스크립트 v5.1.2 (API 페이지네이션 수정)

v5.1.2 새로운 기능:
- 🔧 API 페이지네이션 수정: SSM과 EC2 API에서 모든 인스턴스를 올바르게 조회
- 📈 MaxResults 매개변수 추가: 한 번에 더 많은 결과를 가져와 성능 향상
...
def main():
    ...
    parser = argparse.ArgumentParser(description='AWS EC2/RDS/ElastiCache/ECS 연결 도구 v5.1.2')

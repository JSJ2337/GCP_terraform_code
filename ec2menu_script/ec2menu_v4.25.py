...
# -*- coding: utf-8 -*-
"""
EC2, RDS, ElastiCache 접속 자동화 스크립트 v5.4 (Linux 접속 기능 원복)
...
- Linux SSM 접속 기능을 v4.22의 안정적인 코드로 원복
"""
import os
import sys
import argparse
...
# ----------------------------------------------------------------------------
def main():
    parser = argparse.ArgumentParser(description='AWS EC2/RDS/ElastiCache 연결 도구 v5.4')

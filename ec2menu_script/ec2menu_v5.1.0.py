...
# -*- coding: utf-8 -*-
"""
EC2, RDS, ElastiCache, ECS 접속 자동화 스크립트 v5.1.0

v5.1.0 새로운 기능:
- ⚡ 성능 최적화: 인스턴스 목록 캐싱, 병렬 처리 개선, 백그라운드 새로고침
- 📋 배치 작업: 여러 EC2에 동시 명령 실행, SSM Run Command 활용, 결과 수집
...
def main():
    ...
    parser = argparse.ArgumentParser(description='AWS EC2/RDS/ElastiCache/ECS 연결 도구 v5.1.0')

...
# -*- coding: utf-8 -*-
"""
EC2, RDS, ElastiCache 접속 자동화 스크립트 v4.31 (Jump Host 표시 개선)

- v4.29 버전을 기반으로 Jump Host 선택 화면의 표시 방식 개선.
- RDS/ElastiCache 접속 시, Jump Host 선택 화면에 인스턴스 ID와 Name 태그(호스트 네임)를 함께 표시.
- 다른 모든 기능은 v4.29와 동일하게 유지.
"""
import os
import sys
import argparse
...
# ----------------------------------------------------------------------------
def main():
    parser = argparse.ArgumentParser(description='AWS EC2/RDS/ElastiCache 연결 도구 v4.31')

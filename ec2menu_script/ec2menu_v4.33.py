...
# -*- coding: utf-8 -*-
"""
EC2, RDS, ElastiCache 접속 자동화 스크립트 v4.33 (f-string 문법 오류 최종 수정)

- v4.31 버전을 기반으로 모든 f-string 문법 오류를 수정한 최종 안정화 버전.
- EC2 RDP, RDS, ElastiCache 접속 시 포트 포워딩 파라미터 생성 부분의 문법 오류를 모두 해결.
...
# ----------------------------------------------------------------------------
def main():
    parser = argparse.ArgumentParser(description='AWS EC2/RDS/ElastiCache 연결 도구 v4.33')
